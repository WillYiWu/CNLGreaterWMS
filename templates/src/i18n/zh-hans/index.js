...
export default {
  ...
  outbound: {
    ...
    cancelwrongorder_tip: '取消所有EAN错误订单',
    ...
    view_dn: {
      ...
      dn_unmatchEAN: 'EAN错误',
      dn_cancelled: '客户取消',
      dn_sufficientstock: '库存满足',
      dn_insufficientstock: '库存不足',
      dn_complete: '订单状态',
      goods_qty: '订单数量',
      intransit_qty: '已发货数量',
