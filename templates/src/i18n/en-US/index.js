...
export default {
  ...
  index: {
    ...
    webtitle: 'CNLWMS--Warehouse Management System',
    home: 'Home',
    title: 'CNLWMS',
    title_tip: 'CNLWMS Home',
    hide_menu: 'Hide Menu',
    api: 'API DOCS',
  ...
  releaseallorder: 'Generate PickingList',
  ...
  outbound: {
    ...
    cancelwrongorder_tip: 'Cancel all EAN Unmatched orders',
    ...
    view_dn: {
      ...
      dn_unmatchEAN: 'Unmatched EAN',
      dn_cancelled: 'Customer Cancel',
      dn_sufficientstock: 'Sufficient Stock',
      dn_insufficientstock: 'Insufficient Stock',
      goods_qty: 'Order QTY',
      ...
      total_orderquantity: 'Order Quantity',
      total_weight: 'Total Weight(Unit:KG)',
      total_volume: 'Total Volume(Unit:Cubic Metres)',
      customer: 'Customer',
