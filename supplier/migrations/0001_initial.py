    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "supplier_city",
                    models.CharField(max_length=255, verbose_name="Supplier City"),
                ),
                (
                    "supplier_address",
                    models.CharField(max_length=255, verbose_name="Supplier Address"),
                ),
                (
                    "supplier_contact",
                ...
                (
                    "supplier_manager",
                    models.CharField(max_length=255, verbose_name="Supplier Manager"),
                ),
                (
                    "supplier_level",
                    models.BigIntegerField(default=1, verbose_name="Supplier Level"),
                ),
                (
                    "creater",
