    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "warehouse_city",
                    models.CharField(max_length=255, verbose_name="Warehouse City"),
                ),
                (
                    "warehouse_address",
                    models.CharField(max_length=255, verbose_name="Warehouse Address"),
                ),
                (
                    "warehouse_contact",
                    models.CharField(max_length=255, verbose_name="Warehouse Contact"),
                ),
                (
                    "warehouse_manager",
                    models.CharField(max_length=255, verbose_name="Warehouse Manager"),
                ),
                (
                    "creater",
