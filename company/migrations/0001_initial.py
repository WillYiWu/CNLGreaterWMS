    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "company_city",
                    models.CharField(max_length=255, verbose_name="Company City"),
                ),
                (
                    "company_address",
                    models.CharField(max_length=255, verbose_name="Company Address"),
                ),
                (
                    "company_contact",
                    models.CharField(max_length=255, verbose_name="Company Contact"),
                ),
                (
                    "company_manager",
                    models.CharField(max_length=255, verbose_name="Company Manager"),
                ),
                (
                    "creater",
