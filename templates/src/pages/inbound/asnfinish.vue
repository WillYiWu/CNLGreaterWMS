  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'sku_code', label: this.$t('goods.view_goodslist.sku_code'), field: 'sku_code', align: 'center' },
        { name: 'sku_desc', label: this.$t('goods.view_goodslist.sku_desc'), field: 'sku_desc', align: 'center' },
